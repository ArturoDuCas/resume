...
\resumeItemListStart
\resumeItem{Developed an intelligent traffic light system capable of adjusting light durations based on real-time traffic, pedestrian presence, and weather conditions.}
...
\resumeItem{Programmed Arduino microcontroller for traffic light control using analyzed data.}
\resumeItemListEnd
